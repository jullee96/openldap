...
# give to permission openldap 
log-helper info '-------------------------------------'
log-helper info 'give to permission openldap '
log-helper info '-------------------------------------'

chown -R ${LDAP_OPENLDAP_UID}:${LDAP_OPENLDAP_GID} /var/lib/ldap 
chown -R ${LDAP_OPENLDAP_UID}:${LDAP_OPENLDAP_GID} /etc/ldap/slapd.d


log-helper info "openldap user and group adjustments"
LDAP_OPENLDAP_UID=${LDAP_OPENLDAP_UID:-1000}
LDAP_OPENLDAP_GID=${LDAP_OPENLDAP_GID:-1000}
